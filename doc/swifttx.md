...
This mechanism has been integrated into Bitcore-Node-SPLASHFARMS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SPLASHFARMS-Project/insight-api-splashfarms#web-socket-api](https://github.com/SPLASHFARMS-Project/insight-api-splashfarms#web-socket-api) 
* API: [https://github.com/SPLASHFARMS-Project/insight-api-splashfarms#swifttx-transactions](https://github.com/SPLASHFARMS-Project/insight-api-splashfarms#swifttx-transactions) 
...
By default, the SPLASHFARMS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SPLASHFARMS Core daemon:

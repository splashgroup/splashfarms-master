...
In order to support loading of multiple wallets in splashfarms-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is splashfarms.cpp.
...
Changes to splashfarms.cpp
----------------------
splashfarms.cpp is the entry point into splashfarms-qt, and as such, will require some minor modifications to provide hooks for

...
/**
 * SPLASHFARMS RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzsplaseed(const UniValue& params, bool fHelp);
extern UniValue getzsplaseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzspla(const UniValue& params, bool fHelp);
extern UniValue dzsplastate(const UniValue& params, bool fHelp);

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SplashFarms Core splashfarms-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  splashfarms-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded splashfarms transaction") + "\n" +
                               "  splashfarms-tx [options] -create [commands]   " + _("Create hex-encoded splashfarms transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded splashfarms transaction

...
// Copyright (c) 2016-2018 The SPLASHFARMS developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("SPLA Stake");
    case TransactionRecord::StakeZSPLA:
        return tr("zSPLA Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted SPLA to zSPLA");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSPLA");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received SPLA from zSPLA");
    case TransactionRecord::ZerocoinSpend_Change_zSpla:
        return tr("Minted Change as zSPLA from zSPLA Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSPLA to SPLA");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zSpla:
        return tr("Anonymous (zSPLA Transaction)");
    case TransactionRecord::StakeZSPLA:
        return tr("Anonymous (zSPLA Stake)");
    case TransactionRecord::SendToSelf:
    default:

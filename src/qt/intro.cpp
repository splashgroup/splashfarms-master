...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SPLASHFARMS Core"),
     ...
     * override -datadir in the splashfarms.conf file in the default data directory
     * (to be consistent with splashfarmsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

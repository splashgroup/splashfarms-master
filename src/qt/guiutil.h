...
/** Utility functions used by the SPLASHFARMS Qt UI.
 */
namespace GUIUtil
{
...
// Render SPLASHFARMS addresses in monospace font
...
// Parse "splashfarms:" URI into recipient object, return true on successful parsing

                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSPLAPathCustom = GetArg("-zsplabackuppath", "");
    ...
    if(!strzSPLAPathCustom.empty()) {
        ui->wallet_customzsplabackuppath->setText(QString::fromStdString(strzSPLAPathCustom));
        ui->wallet_customzsplabackuppath_label->setVisible(true);
        ui->wallet_customzsplabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSPLAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SPLASHFARMS RPC console.") + "<br>" +

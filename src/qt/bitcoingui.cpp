                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SPLASHFARMS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SPLASHFARMS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and splashfarms: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSPLA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SPLASHFARMS Core"), this);
    aboutAction->setStatusTip(tr("Show information about SPLASHFARMS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SPLASHFARMS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SPLASHFARMS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SPLASHFARMS addresses"));
    ...
    openAction->setStatusTip(tr("Open a SPLASHFARMS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SPLASHFARMS Core help message to get a list with possible SPLASHFARMS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SPLASHFARMS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SPLASHFARMS network", "", count));
}
...
{
    QString strTitle = tr("SPLASHFARMS Core"); // default title

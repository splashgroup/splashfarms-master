...
#   c) node1 mines 32 blocks, so now node 0 has 60001spla, node 1 has 4250spla, node2 has none.
#   d) node0 sends 601 spla to node2, in two transactions (301 spla, then 300 spla).

...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/splashfarms-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/splashfarms-cli.cpp \
           src/splashfarms-tx.cpp \
           src/splashfarms.cpp \
           src/db.cpp \
           ...
           src/qt/splashfarms.cpp \
           src/qt/splashfarmsstrings.cpp \
...
RESOURCES += src/qt/splashfarms.qrc src/qt/splashfarms_locale.qrc

TRANSLATIONS += src/qt/locale/splashfarms_bg.ts \
                src/qt/locale/splashfarms_de.ts \
                src/qt/locale/splashfarms_en.ts \
                src/qt/locale/splashfarms_es.ts \
                src/qt/locale/splashfarms_fi.ts \
                src/qt/locale/splashfarms_fr.ts \
                src/qt/locale/splashfarms_it.ts \
                src/qt/locale/splashfarms_ja.ts \
                src/qt/locale/splashfarms_pl.ts \
                src/qt/locale/splashfarms_pt.ts \
                src/qt/locale/splashfarms_ru.ts \
                src/qt/locale/splashfarms_sk.ts \
                src/qt/locale/splashfarms_sv.ts \
                src/qt/locale/splashfarms_vi.ts \
                src/qt/locale/splashfarms_zh_CN.ts \
                src/qt/locale/splashfarms_zh_TW.ts

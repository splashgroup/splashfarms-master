Contributing to SPLASHFARMS Core
============================

The SPLASHFARMS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SPLASHFARMS Core project, and is not to be
confused with overall SPLASHFARMS Network Protocol consensus changes.

Whether a pull request is merged into SPLASHFARMS Core rests with the project merge
...
Patches that change SPLASHFARMS consensus rules are considerably more involved than
...
Where a patch set proposes to change the SPLASHFARMS consensus, it must have been
...
The project leader is the release manager for each SPLASHFARMS Core release.
